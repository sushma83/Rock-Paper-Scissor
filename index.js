        ...
        for(var j=0;j<=buttonClass.length;j++){
            if(buttonClass[j]==="red"||"yellow"||"blue"){
                ...
                switch(user){
                    ...
                    document.querySelector(".user button img").src="icon-rock (1).svg";
                    ...
                    document.querySelector(".play-div .player img").src="icon-rock (1).svg";
                    break;
                    ...
                    document.querySelector(".user button img").src="icon-scissors (1).svg";
                    ...
                    document.querySelector(".play-div .player img").src="icon-scissors (1).svg";
                    break;
                    ...
                    document.querySelector(".user button img").src="icon-paper (1).svg";
                    ...
                    document.querySelector(".play-div .player img").src="icon-paper (1).svg";
                    break;
...
function computerChoice(){
    ...
    switch(computerColour){
        case "red":setTimeout(function(){
            ...
            document.querySelector(".comp button img").src="icon-rock (1).svg";},500);
            document.querySelector(".play-div .bot").classList.remove("yellow","blue");
            document.querySelector(".play-div .bot").classList.add("red");
            document.querySelector(".play-div .bot img").src="icon-rock (1).svg";
        break;
        ...
        case "yellow":setTimeout(function(){
            ...
            document.querySelector(".comp button img").src="icon-scissors (1).svg";},500);
            document.querySelector(".play-div .bot").classList.remove("red","blue");
            document.querySelector(".play-div .bot").classList.add("yellow");
            document.querySelector(".play-div .bot img").src="icon-scissors (1).svg";
        break;
        ...
        case "blue":setTimeout(function(){
            ...
            document.querySelector(".comp button img").src="icon-paper (1).svg";},500);
            document.querySelector(".play-div .bot").classList.remove("yellow","red");
            document.querySelector(".play-div .bot").classList.add("blue");
            document.querySelector(".play-div .bot img").src="icon-paper (1).svg";
        break;
